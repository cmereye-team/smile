        ...
        <div class="md:flex">
          <div class="regard" :class="[$i18n.locale == 'en' ? 'regard regardEng':'regard']">
            <img
              ...
              class="mb-5 ml-3"
            />
            <span v-html="$t('notice.techProcess.regard.span2')"></span>
          </div>
          <div class="regard">
            <img
              ...
              class="mb-5"
            />
            <span v-html="$t('notice.techProcess.regard.span3')"></span>
          </div>
        </div>
      </div>
      <div class="regard-box text-center" :class="[$i18n.locale == 'en' ? 'regard-box regard-boxEng':'regard-box']">
        ...
        <div class="md:flex">
          <div class="regard">
            <img
              ...
              class="mb-5"
            />
            <span>{{$t('notice.techProcess.regard.span4')}}</span>
          </div>
          <div class="regard">
            <img
              ...
              class="mb-5"
            />
            <span v-html="$t('notice.techProcess.regard.span5')"></span>
          </div>
        </div>
      </div>
    </div>
