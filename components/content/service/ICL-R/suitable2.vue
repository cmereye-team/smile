  ...
  <div class="guest">
    <div class="bg-photo">
      <div class="nav-four">
        ...
        <div>
          <div v-for="item in guestList" :key="item.id">
    ...
    .nav-four {
      ...
      & > div:nth-child(1) {
        ...
        & > p:nth-child(4) {
          ...
          letter-spacing: 1.603vw;
        }
      }
      & > div:nth-child(2) {
        max-width: 100%;
        padding: 36.923vw 0 21.026vw;
        display: grid;
        grid-template-columns: repeat(2, 1fr); /* 创建4列，每列宽度相等 */
        grid-auto-rows: auto; /* 自动行高 */
        grid-gap: 15.846vw 5.897vw; /* 可选：设置网格间隙 */
        & > div {
          width: 39.487vw;
          height: 39.487vw;
          display: flex;
