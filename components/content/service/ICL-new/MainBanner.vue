<template>
  <div class="main_banner">
    <div class="smile-banner">
      <img
        data-src="https://statichk.cmermedical.com/imgs/2023/10/a7c9279d1d234f49.png"
        srcset="
          https://statichk.cmermedical.com/imgs/2023/10/1de0aa651f60fde6.png 768w,
          https://statichk.cmermedical.com/imgs/2023/10/a7c9279d1d234f49.png
        "
        src="https://statichk.cmermedical.com/imgs/2023/10/a7c9279d1d234f49.png"
        alt=""
      />
      <div class="title_box">
        <h1 class="title">ICL {{ "\n" }}植入式隱形眼鏡</h1>
...
.smile-banner {
  ...
  max-width: 1280px;
  margin: 0 auto;
  border-radius: 61px 0 61px 61px;
  overflow: hidden;
  position: relative;
  & > img {
    width: 100%;
