module.exports = {
  home: {
    ...
    aspiration: {
      ...
      p4: "陳欣妍",
      span1:
        "Every time I open my eyes, I wonder if I forgot to remove my contact lenses",
      span2_1:
        "I have never experienced being able to see clearly for whole day long until now",
      span2_2: "",
      span3_1:
        "It feels more comfortable not to wear contact lenses/glasses while acting!",
      span3_2: "",
      span4:
        "I can wear non-prescription glasses that won't make my eyes look smaller in the coming days",
    },
    VedioSlider: {
      p: "個案分享",
      span: "More",
  ...
  aboutUs: {
    centreIntroduction: {
      ...
      Se3CentreInfor: {
        ...
        span2:
          'SMILE Refractive Surgery Centers is a refractive correction medical center under the listed company "Hong Kong C-MER Eye Care Holdings Ltd.',
        span3:
          "The center is led by Professor Dennis Lam, who was the first to introduce LASIK technology to Hong Kong. The team consists of 12 ophthalmologists, several registered optometrists, and nurses.",
        span4:
          'The doctors are experienced, with three of them being among the "Ten Outstanding Young Persons of Hong Kong", and they have a good reputation in terms of safety and technology. ',
        span5:
          "As an ophthalmology center that was the first to introduce laser correction technology, the center complies with FDA laser correction standards：and is equipped with advanced ophthalmic examination and instruments.；The center provides comprehensive and accurate eye examinations for customers,and designs strict and targeted correction plans according to different conditions. ",
        span6:
          'The center upholds the principle of "tailor-made" and provides qualified services：including ReLEx SMILE, LASIK, Implantable Collamer Lens (ICL), and artificial lens replacement surgery. It relieves customers who suffer from myopia, hyperopia, astigmatism, presbyopia, and cataracts, improving their vision and realizing the ideal of "hope to see beauty',
      },
      huanjswiper: {
  ...
  chargeDetail: {
    ...
    span2:
      "Refund of presurgery examination fee after completion of vision correction surgery",
    span3:
      "# It has to be completed within one year after the surgery. If it exceeds one year, another appointment needs to be scheduled, and the consultation fee will be charged at the regular (non-corrective package) rate.",
    span19:
      "## It has to be completed within two year after the surgery. If it exceeds one year, another appointment needs to be scheduled, and the consultation fee will be charged at the regular (non-corrective package) rate.",
    ...
    span11:
      "Designated credit card enjoys 6/12/18/24/36 months Interest-fee installment",
    span12: "Single-focal IOL",
    span13: "Astigmatic Single-focal IOL",
    span14: "5 follow-up consultations",
    span15: "Premium",
    span16:
      "It has to be completed within two years after the surgery. If it exceeds one year, another appointment needs to be scheduled, and the consultation fee will be charged at the regular (non-corrective package) rate.",
    span21:
      "Surgery charges include the preoperative examination fee of HKD$100. ",
    span22:
      "Surgery charges include the preoperative examination fee of HKD$500. ",
    span20:
      "If there is no surgery scheduled, the preoperative examination fee will be charged separately.",
    p3: "帶散光",
  ...
  contactUs: {
    ...
    googleMap: {
      ...
      address1:
        "Room 1512, Central Building, 1-3 Pedder Street, Central（Exit G, Central MTR Station, upstairs at The Landmark）",
      address2: "百德新街2-20號恒隆中心1614 -15室 (港鐵站E出口)",
      address3:
        "Room 702, One Grand Tower, 625 and 639 Nathan Road, Mong Kok （Mong Kok MTR Station Exit E1）",
      address4:
        "Room 1906, K11 ATELIER Victoria Dockside, 18-24 Salisbury Road, Tsim Sha Tsui（Tsim Sha Tsui MTR Station Exit J2）",
      ...
      address8:
        "Room 1906, 19/F, K11 ATELIER, 18-24 Salisbury Road (near K11 MUSEA)",
      ...
      address15:
        "Shop G55-56, G/F, Metro City Phase I, 1 Wan Hang Road (Po Lam MTR Station, Exit B2)",
    },
    serveTable: {
      title: "Hotline",
      th1: "Service Center",
  ...
  freQuestios: {
    ...
    secondProblem: {
      ...
      problem7: {
        title:
          "If I blink during the process of LASIK, will it affect the outcome?",
      ...
      problem14: {
        title:
          "What types of patients are required to have LASIK Xtra or Cross-linking surgery?",
    ...
    thirtProblem: {
      problem1: {
        title:
          "What is the corrective range of ICL implantable contact lenses?",
      ...
      problem3: {
        title:
          "Will I feel any foreign body sensation after ICL implanted contact lenses?",
      ...
      problem5: {
        title:
          "Why are ICL implantable contact lenses more expensive than SMILE and LASIK??",
  ...
  notice: {
    ...
    techProcess: {
      process: {
        ...
        span1:
          "After detailed eye examinations and consultations, our medical staff will inform you if you are suitable for vision correction",
  ...
  ophthalmicInfo: {
    ...
    consumption: {
      ...
      tableTitle:
        "If you have any questions, please feel fee to contact our customer service representatives for assistance.",
    ...
    divit: {
      ...
      contentText:
        "FPS by divit is now available for payment in C-MER Smile Refractive Center.",
      contentText0_1:
      ...
      contentText1:
        "FPS by divit is available in Tsim Sha Tsui Refractive Center only",
      contentText2:
        "Room 1906, K11 ATELIER Victoria Dockside, 18-24 Salisbury Road, Tsim Sha Tsui（Tsim Sha Tsui MTR Station Exit J2）",
      tableTitle:
        "If you have any questions, please feel fee to contact our customer service representatives for assistance.",
  ...
  service: {
    ...
    smilePro: {
      ...
      smileProFeatures: {
        ...
        context:
          "ZEISS VISUMAX 800 SMILE®pro Vision correction using German Zeiss optics and Nobel Prize-winning laser technology",
        lists: [
          {
