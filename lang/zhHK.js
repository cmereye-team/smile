...
module.exports = {
  ...
  aboutUs: {
    centreIntroduction: {
      ...
      Se3CentreInfor: {
        ...
        span3: '中心團隊由最早將LASIK矯視技術引進香港的林順潮教授帶領，加上12名眼科專科醫生、多名註冊視光師及護士組成。',
        span4: '醫生經驗豐富，其中有3名為「香港十大傑出青年」，在安全、技術各方面都有良好口碑。',
        span5: '作為率先引入激光矯視技術的眼科中心，中心符合FDA激光矯視標準：設有符合國際標準的無菌手術室，配備先進的眼科檢查和矯視儀器；為客人作全面、準確的眼科檢查，並根據不同情況定制嚴格且有針對性的矯視方案。',
        span6: '中心秉持「度身訂造」原則，提供品質服務：包括SMILE微笑激光矯視、LASIK激光矯視、植入式隱形眼鏡(ICL)，及人工晶體置換術，舒緩有近視、遠視、散光、老花以及白內障客人的困擾，讓客人改善視力，實踐「希．望見美好」的理想。'
      },
      huanjswiper: {
        h3: '中心環境舒適寬敞、地點便利',
  ...
  chargeDetail: {
    ...
    span19: '##需要術後兩年內完成。如超過兩年，需另作預約，診金按正常（非矯視套餐）收費',
    span17: '以上為非指定醫生價錢',
