module.exports = {
  ...
  fee: {
    ...
    textList: {
      ...
      text5:
        "SMILE微笑激光矯視、LASIK激光矯視/TPRK經上皮激光角膜切削手術及ICL植入式隱形眼鏡的無限視光檢查需要術後一年內完成。如超過一年，需另作預約，診金按正常（非矯視套餐）收費；SMILEPro微笑激光矯視及SMILE Pro Care微笑激光矯視的無限視光檢查需要術後兩年內完成。如超過兩年，需另作預約，診金按正常（非矯視套餐）收費。",
