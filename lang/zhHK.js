  ...
  service: {
    ...
    relexSmile: {
      ...
      xtra: {
        ...
        p4: `透過在角膜局部加入維生素B2,再經<br class="mbShow" />紫外線V2照射,<br class="pcShow" />使角膜裡面的膠原蛋白<br class="mbShow" />緊扣,令角膜變得更加堅韌和穩定,<br />降低角膜降弧／變形／反彈的寬度`,
        h5_2: "我需要接受SMILE XTRA?",
        p5: `如果你的眼晴度數較深、角膜比較薄，<br />希望加強角膜以減低度數反彈機會，<br />經醫生評估後均可接受SMILE XTRA<br class="mbShow" />角膜膠原交聯術。`,
      },
    },
    smilePro: {
      smileProDesc: {
