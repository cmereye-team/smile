...
export default {
  components: { Header, Navbar, Footer, MainBanner, process, footers, regard },
  data() {
    return {
      canonicalHref: "https://smile.hkcmereye.com/Notice/techProcess",
      canonicalHrefCN: "https://smile.hkcmereye.com/cn/Notice/techProcess",
      browserTitle: "矯視流程 - 香港希瑪微笑矯視中心",
      browserTitleCn: "矯視流程 - 香港希玛微笑矫视中心",
    };
  },
  head() {
    return {
      ...
      link: [
        ...
        },
        {
          rel: "alternate",
          hreflang: "x-default",
          href: "https://smile.hkcmereye.com/techProcess",
        },
        {
          rel: "alternate",
          hreflang: "zh-Hant-HK",
        ...
        },
        {
          rel: "alternate",
          hreflang: "zh-Hans-CN",
          href: "https://smile.hkcmereye.com/cn/techProcess",
        },
      ],
    };
  },
