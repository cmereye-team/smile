    ...
    .icl-WhatChoose-content-one {
      ...
      .icl-WhatChoose-content-one-text {
        ...
        p {
          color: #6d6e71;
          font-family: "Noto Sans TC" !important;
          font-size: clamp(8px, 4.1vw, 16px);
          font-style: normal;
          font-weight: 300;
          line-height: 1.75;
      ...
      .visionBattle-Box-list {
        ...
        & > .visionBattle-Box-list-item:nth-child(3) {
          ...
          &::before {
            ...
            width: 103.08vw;
            height: 90.26vw;
            background: url("data:image/svg+xml;base64,");
            background-repeat: no-repeat;
...
@media screen and (min-width: 992px) {
  ...
  .visionBattle {
    ...
    margin-bottom: clamp(60px, 9.792vw, 188px);
    .visionBattle-Bg {
      position: absolute;
      ...
      .visionBattle-Box-list {
        ...
        & > .visionBattle-Box-list-item:nth-child(1) {
          ...
          &::before {
            ...
            width: 358px;
            aspect-ratio: 1 / 1;
            background: url("https://statichk.cmermedical.com/cmermedical/image/20260317/bg2.png");
            background-repeat: no-repeat;
            background-size: 100% 100%;
            z-index: -1;
          }
        ...
        & > .visionBattle-Box-list-item:nth-child(2) {
          ...
          &::before {
            ...
            width: 300px;
            aspect-ratio: 1 / 1;
            background: url("https://statichk.cmermedical.com/cmermedical/image/20260317/bg1.png");
            background-repeat: no-repeat;
            background-size: 100% 100%;
            z-index: -1;
          }
        ...
        & > .visionBattle-Box-list-item:nth-child(3) {
          ...
          &::before {
            ...
            width: 400px;
            aspect-ratio: 1 / 1;
            background: url("https://statichk.cmermedical.com/cmermedical/image/20260317/bg3.png");
            background-repeat: no-repeat;
            background-size: 100% 100%;
            z-index: -1;
          }
        ...
        <div class="ClearVisionBanner-Box">
          <div class="ClearVisionBanner-Box-content">
            <div class="ClearVisionBanner-Box-content-title">
              ...
              <p>
                <a
                  href="/vision-correction-presbyopia#CorrectionProgram"
                  @click.prevent="scrollTo('CorrectionProgram')"
                  >PRESBYOND Laser Blended Vision、CMER CLEAR-Vision</a
                >及<a
                  :href="
                    !isMobile
            ...
            <div class="ClearVisionBanner-Box-content-img">
              <img
                decoding="async"
                src="https://statichk.cmermedical.com/smile/clear-visionV2/ClearVisionBanner-bg-pc1.avif"
                alt=""
                loading="lazy"
                width="100%"
                height="100%"
                srcset="
                  https://statichk.cmermedical.com/smile/clear-visionV2/ClearVisionBanner-bg-mb.webp  400w,
                  https://statichk.cmermedical.com/smile/clear-visionV2/ClearVisionBanner-bg-mb.webp  640w,
                  https://statichk.cmermedical.com/smile/clear-visionV2/ClearVisionBanner-bg-pc1.avif
                "
          ...
          <div class="CorrectionProgram-Box-hide-item-container">
            <div class="CorrectionProgram-Box-hide-item">
              ...
              <div class="CorrectionProgram-Box-hide-item-bottom">
                ...
                >
                  又名視覺融合老花激光手術，是一項個性化的
                  <span>全距離視力</span>
                  老花矯視方案；透過結合Zeiss蔡司系統及準分子激光技術<span
                    >矯正老花、近視、遠視、散光</span
                  >
            ...
            <div class="CorrectionProgram-Box-hide-item">
              <div class="CorrectionProgram-Box-hide-item-top">
                <img
                  src="https://statichk.cmermedical.com/cmermedical/image/20260317/image22.webp"
                  alt=""
                />
                <div class="CorrectionProgram-Box-hide-item-top-text">
                  <span class="CorrectionProgram-Box-hide-item-sub">適合</span>
            ...
            <div class="CorrectionProgram-Box-hide-item">
              <div class="CorrectionProgram-Box-hide-item-top">
                <img
                  src="https://statichk.cmermedical.com/cmermedical/image/20260317/image23.webp"
                  alt=""
                />
                <div class="CorrectionProgram-Box-hide-item-top-text">
                  <span class="CorrectionProgram-Box-hide-item-sub">適合</span>
          ...
          <div class="visionBattle-Box-list-item">
            <div class="visionBattle-Box-list-item-content">
              ...
              <p>
                ...
                />
                <span
                  >準確度提升: 激光打磨速度升至<br />500Hz，比上一代提高一倍</span
                >
              </p>
              <p>
                <img
                ...
                />
                <span
                  >根據個人眼睛實際狀況和生活需要，度<br />身訂造治療方案</span
                >
              </p>
              <p>
                <img
                ...
                <div class="flex items-center justify-center">
                  ...
                  >
                    <div class="flex-shrink-0 mr-2 relative">
                      <!-- <img
                        src="https://statichk.cmermedical.com/cmermedical/image/20260330/500Hz.svg"
                        alt="500Hz Logo"
                        class="h-[48px] md:h-[72px] w-auto object-contain"
                      /> -->
                      <svg
                        class="h-[64px] md:h-20"
                        viewBox="0 0 132 82"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <path
                          d="M14.47 21.847h14.44l-1.275 6.557h-2.96l.893-4.594h-8.68l-.893 4.594h-2.8zm2.84 2.473h7.66l-.318 1.63h-7.66zm-.417 2.14h7.58l-.332 1.709h-7.58zm-5.631 2.219h18.1l-.435 2.238h-18.1zm8.837 2.69h6.22l-.416 2.14h-6.22zm-6.004.02h4.34l-.374 1.923h-4.34zm-.477 2.453h4.34l-.374 1.924h-4.34zm8.767-.55q.507 1.61 1.938 2.788 1.43 1.179 3.652 1.689-.33.255-.746.648-.396.392-.776.805-.364.432-.61.765-2.415-.745-3.857-2.277-1.418-1.55-2.043-3.79zm3.294-1.923h.52l.495-.079 1.655.648q-.986 2.08-2.346 3.632a14.3 14.3 0 0 1-3.052 2.63 16.8 16.8 0 0 1-3.663 1.768 7 7 0 0 0-.471-1.178 5.2 5.2 0 0 0-.638-1.04 13 13 0 0 0 3.076-1.316 11.8 11.8 0 0 0 2.556-2.042 10.4 10.4 0 0 0 1.792-2.63zM9.513 36.748l2.347-.137q1.335-.08 2.795-.177 1.482-.118 2.941-.216l-.38 2.16q-2.081.215-4.176.392l-3.728.353zm7.828-7.343h2.78L18.06 40.007h-2.78zm-4.712.06h2.64l-1.564 8.049h-2.64zm29.849-1.69h7.48l-.512 2.632h-7.48zm-10.119-4.534h9.1l-.447 2.297h-9.1zm-1.703 7.833h9.2l-.461 2.376h-9.2zm.544-3.514h9.74l-.45 2.317h-9.74zm14.028 1.394h2.82L45.92 39.909H43.1zM32.76 25.91l2.407-.55q.096.432.157.942.064.492.072.864l-2.506.648a9 9 0 0 0-.02-.923 9 9 0 0 0-.11-.981m4.95-.57 2.53.472-.864 1.354a15 15 0 0 1-.75 1.08l-2.248-.471q.228-.354.468-.766.245-.432.468-.864.248-.45.397-.805m10.92-3.907 1.792 2.101q-1.185.432-2
2.082-.81-2.827-.696-.746-1.776-.746-1.04 0-2.065.746t-1.95 2.827q-.924 2.08-1.702 6.086-.779 4.005-.679 6.165.108 2.12.828 2.945.727.785 1.767.785m13.12 4.869 3.128-16.09h3.938l-1.192 6.134h5.39l1.192-6.133h3.916l-3.127 16.089h-3.916l1.284-6.609h-5.39l-1.284 6.609zm16.114 0 .399-2.052 6.488-7.235h-4.51l.584-3.001h9.393l-.398 2.051-6.489 7.235h5.258l-.583 3.002zm-8.805-33.603c5.247 8.499 15.48 10.693 24.601 7.684a31.58 31.58 0 0 0 18.036-15.32c2.343-4.466 3.432-9.322 2.982-14.266-.757-8.348-6.568-15.022-14.767-16.73-9.255-1.928-18.782 2.05-25.232 8.728-.595.616-1.598.65-2.108.008-.509-.642-.368-1.405.251-2.032 3.986-4.026 8.716-7.053 14.181-8.68 4.557-1.356 9.236-1.651 13.815-.6 8.819 2.02 15.218 9.022 16.435 17.97.624 4.577.056 9.108-1.612 13.5-3.421 9-10.638 16.15-19.657 19.55-5.269 1.987-10.844 2.473-16.272 1.098s-10.118-4.694-13-9.513c-.428-.715-.2-1.541.373-1.899.73-.457 1.53-.214 1.97.502z"
                          fill="currentColor"
                        />
                        <path
                          d="m112.615 34.86-9.295-4.831c-.48-.247-.617-.944-.521-1.468l3.336-18.067c.118-.642.959-.992 1.447-.925.512.07 1.357.6 1.217 1.371l-3.144 17.23 8.048 4.204c.594.31.849 1.077.683 1.57-.188.557-1.015 1.31-1.768.919zm-24.137-6.741H65.072c-.9 0-1.428-.517-1.483-1.276-.059-.83.528-1.43 1.483-1.43h23.406c.83 0 1.391.585 1.41 1.279.018.748-.513 1.427-1.41 1.427m-10.244 9.783H54.74c-.856 0-1.406-.546-1.461-1.302-.04-.545.457-1.427 1.273-1.427l23.59-.007a1.4 1.4 0 0 1 1.424 1.294c.04.623-.384 1.442-1.336 1.442zm3.498-22.279c.945 0 1.358.627 1.424 1.29.063.609-.465 1.442-1.332 1.442H58.253c-.83 0-1.336-.704-1.355-1.272-.025-.76.432-1.456 1.351-1.456h23.48z"
                          fill="currentColor"
                        />
                      </svg>
                    </div>
          ...
          <div class="visionBattle-Box-list-item">
            <div class="visionBattle-Box-list-item-content">
              ...
              <p>
                ...
                />
                <span
                  >有不同人工晶體可供選擇，包括多焦距人工<br />晶體、單焦距人工晶體、散光多焦距人工<br
        ...
        <table class="model-table w-full">
          <thead>
            <tr class="line-bottom">
              <th class="table-item">
                {{ $t("service.clearVision.model.project.title") }}
              </th>
          ...
          <tbody>
            ...
            <tr class="line-bottom">
              <th class="table-item">
                {{ $t("service.clearVision.model.reversibility.title") }}
              </th>
              <td>
...
export default {
      ...
      iclGoodList: [
        {
          ...
          text: ["最快術後一天", "可如常生活或工作"],
          mbText: ["最快術後一天", "可如常生活或工作"],
        },
        {
  ...
  methods: {
    ...
    startMobileAnimation() {
      const showEl = this.$refs.boxShow;
      setTimeout(() => {
        showEl.style.transform = "translateY(-1000%)";
      }, 1000);
    },
  },
  beforeUnmount() {
