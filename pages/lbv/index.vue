...
@media screen and (max-width: 991px) {
    ...
    .SuitableObject {
        ...
        .SuitableObject-Box {
            ...
            &::after {
                ...
                top: -4.62vw;
                left: -25.64vw;
                background: url("https://statichk.cmermedical.com/smile/vision-correction-iclV2/SuitableObject/SuitableObject-mb-line.svg") no-repeat;
                background-size: 100% auto;
                width: 174.62vw;
                height: 76.92vw;
                z-index: -1;
    ...
    .clearAppointment {
        ...
        // margin-top: 13.59vw;
        height: 85.64vw;
        background: url("https://statichk.cmermedical.com/smile/clear-visionV2/clearAppointment/clearAppointment-mbBg.avif") no-repeat;
        background-size: 100% auto;
        display: flex;
        flex-direction: column;
        justify-content: center;
...
@media screen and (min-width: 992px) {
                ...
                .CorrectionProgram-Box-hide-item {
                    ...
                    .CorrectionProgram-Box-hide-item-top {
                        ...
                        .CorrectionProgram-Box-hide-item-top-text {
                            ...
                            background: #4570b6;
                            padding: clamp(10px, 1.04vw, 20px) clamp(17.5px, 1.82vw, 35px) clamp(14px, 1.46vw, 28px) clamp(11px, 1.15vw, 22px);
                            border-radius: 5px;
                            border-top-left-radius: 0px;
                            color: #fff;
                            font-family: "Noto Sans TC";
                            ...
                            .CorrectionProgram-Box-hide-item-sub {
                                ...
                                width: fit-content;
                                background: #4570b6;
                                padding: clamp(5px, 0.52vw, 10px) clamp(11px, 1.15vw, 22px) 0 clamp(11px, 1.15vw, 22px);
                                border-top-left-radius: 5px;
                                border-top-right-radius: 5px;
                                color: #fff;
                                font-family: "Noto Sans TC";
    ...
    .SuitableObject {
        ...
        .SuitableObject-Box {
            ...
            &::after {
                ...
                background: url(https://statichk.cmermedical.com/smile/vision-correction-iclV2/SuitableObject/SuitableObject-pc-line.svg) no-repeat;
                background-size: 100% auto;
            ...
            .card {
                ...
                &-header {
                    ...
                    .header-title[aria-expanded="false"] {
                        ...
                        border-radius: 10px;
                        padding: clamp(6.5px, 0.68vw, 13px) clamp(15px, 1.56vw, 30px) clamp(6.5px, 0.68vw, 13px) clamp(26.5px, 2.76vw, 53px);
                    }
                    ...
                    .card-body {
                        ...
                        span {
                            ...
                            border-bottom-left-radius: 10px;
                            border-bottom-right-radius: 10px;
                            padding: clamp(10px, 1.04vw, 20px) clamp(26.5px, 2.76vw, 53px) clamp(10px, 1.04vw, 20px) clamp(26.5px, 2.76vw, 53px);
    ...
    .clearAppointment {
        ...
        background: url("https://statichk.cmermedical.com/smile/clear-visionV2/clearAppointment/clearAppointment-mbPc.avif") no-repeat;
        background-size: 100% auto;
        display: flex;
        justify-content: center;
        align-items: center;
        ...
        .clearAppointment-Box {
            ...
            .clearAppointment-Box-item {
                ...
                border: clamp(0.5px, 0.05vw, 1px) solid #4570b6;
                background: #fff;
                box-shadow: clamp(5px, 0.52vw, 10px) clamp(5px, 0.52vw, 10px) 0px 0px #4570b6;
                ...
                &:hover {
                    .clearAppointment-Box-item-icon {
                        background: white;
                        box-shadow: 0 clamp(1px, 0.1vw, 2px) clamp(2.5px, 0.26vw, 5px) rgba(0, 0, 0, 0.25);
    ...
    <div class="lasik" style="overflow-x: hidden">
      ...
      />
                    ...
                    <div class="ClearVisionBanner-Box-content">
                        <div class="ClearVisionBanner-Box-content-title">
                            <a href="/vision-correction-presbyopia#CorrectionProgram"
                                @click.prevent="scrollTo('CorrectionProgram')">Presbyopia <br class="d-lg-none" />
                                Treatments</a>

                            <h1>老花矯視</h1>
                            <p>
                                希瑪微笑矯視中心主要提供三種<br class="d-lg-none" />可矯正老花的矯視服務
                            </p>
                            <p>
                                <a href="/vision-correction-presbyopia#CorrectionProgram"
                                    @click.prevent="scrollTo('CorrectionProgram')">PRESBYOND Laser Blended Vision、CMER
                                    CLEAR-Vision</a>及<a
                                    :href="!isMobile ? '/vision-correction-presbyopia#CorrectionProgram' : '/vision-correction-presbyopia#CorrectionProgramTwo'"
                                    @click.prevent="!isMobile ? scrollTo('CorrectionProgram') : scrollTo('CorrectionProgramTwo')">ICL
                                    Viva V6 </a>
                            </p>
                            <p>
                                如你正受以下老花問題困擾，<br class="d-lg-none" />可參考本頁有關老花矯視服務的詳盡介紹。
                            </p>
                        </div>
                ...
                <div class="WhatLaoHuaBox-text">
                    ...
                    <p>
                        老花並非疾病，而是隨著年齡增長而自然出現的現象。一般在40歲開始出現，到60歲時會達到較為穩定的狀態。為了改善老花帶來的視力問題，人們可以選擇配戴老花眼鏡、使用隱形眼鏡或接受老花矯視手術等方式，這些方法都可幫助改善近距離的視力，使日常生活中的閱讀和近距離工作變得更加容易，而進行<span
                            id="CorrectionProgram">老花矯視更是受大眾歡迎的選項</span>。
                    </p>
                </div>
            </div>
        </section>
        ...
        <a target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="29" viewBox="0 0 30 29" fill="none">
                <path d="M3.19922 26.0597L25.8278 3.43115" stroke="white" stroke-width="5.4" stroke-linecap="round" />
                <path d="M6.49707 2.71118H26.5997V22.1512" stroke="white" stroke-width="4.86" stroke-linecap="round" />
            </svg>
        </a>
      ...
      <div class="icl-WhatChoose-content-one container new-container">
                    ...
                    <div class="visionBattle-Box-list-item">
                        ...
                        <div class="visionBattle-Box-list-item-content">
                            ...
                            <p>
                                <img src="https://statichk.cmermedical.com/smile/clear-visionV2/clearAppointment/success.svg"
                                    alt="" />
                                <span>根據個人眼睛實際狀況和生活需要，<br />度身訂造治療方案</span>
                            </p>
                            <p>
                                <img src="https://statichk.cmermedical.com/smile/clear-visionV2/clearAppointment/success.svg"
                                    alt="" />
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="70" height="118" viewBox="0 0 70 118"
                                ...
                                <g clip-path="url(#clip0_12727_103)">
                                    <path
                                        ...
                                        fill="#4570B6" />
                                    <path d="M70.0005 0L45.123 33.2321H49.7554L70.0005 0Z" fill="#4570B6" />
                                    <path d="M2.89453 118L27.772 84.7678H23.1396L2.89453 118Z" fill="#4570B6" />
                                    <path
        ...
        <section class="clearAppointment">
            <div class="clearAppointment-Box">
                <a href="/ophthalmicInfo/AppointForm" class="clearAppointment-Box-item">
                    <img src="https://statichk.cmermedical.com/smile/clear-visionV2/clearAppointment/laohua.svg"
                        alt="" />
                    <p>預約老花講座</p>

                    <div class="clearAppointment-Box-item-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="49" height="42" viewBox="0 0 49 42" fill="none">
                            <path d="M3.57595 20.4719L40.719 20.472" stroke="white" stroke-width="6.26756"
                                stroke-linecap="round" />
                            <path d="M27.7695 37.561L44.268 21.0626L28.3134 5.10799" stroke="white"
                                stroke-width="5.64081" stroke-linecap="round" />
                        </svg>
                    </div>
                </a>
                ...
                <a target="_blank"
                    ...
                    <img src="https://statichk.cmermedical.com/smile/clear-visionV2/clearAppointment/zixun.svg"
                        alt="" />
                    <p>預約諮詢</p>
                    <div class="clearAppointment-Box-item-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="49" height="42" viewBox="0 0 49 42" fill="none">
        ...
        <section class="SuitableObject">
            <img class="SuitableObject-bg-right" decoding="async"
            ...
            <div class="SuitableObject-Box container">
                ...
                <div class="SuitableObject-Box-List">
                    <div class="SuitableObject-Box-List-item">
                        <img src="https://statichk.cmermedical.com/smile/vision-correction-iclV2/SuitableObject/SuitableObject-itemImg-10.svg"
                            alt="" />
                        <p>39歲以上</p>
                    </div>

                    <div class="SuitableObject-Box-List-item">
                        <img src="https://statichk.cmermedical.com/smile/vision-correction-iclV2/SuitableObject/SuitableObject-itemImg-2.svg"
                            alt="" />
                        <p>熱愛運動</p>
                    </div>

                    <div class="SuitableObject-Box-List-item">
                        <img src="https://statichk.cmermedical.com/smile/vision-correction-iclV2/SuitableObject/SuitableObject-itemImg-3.svg"
                            alt="" />
                        <p>
                            佩戴多副矯正度數眼鏡<br /><span>(近視、遠視、<br />散光、老花)</span>
                        </p>
                    </div>

                    <div class="SuitableObject-Box-List-item">
                        <img src="https://statichk.cmermedical.com/smile/vision-correction-iclV2/SuitableObject/SuitableObject-itemImg-4.svg"
                            alt="" />
                        <p>不愛佩戴眼鏡<br />或隱形眼鏡</p>
                    </div>
                </div>
                    ...
                    <div id="accordion">
                        <div class="card collapseActive expanded">
                            <div class="card-header d-flex flex-column-reverse">
                                ...
                                <a data-bs-toggle="collapse" id="toCSC" class="d-flex header-title position-relative"
                                    href="#collapseOne" aria-expanded="true">
                                    <!-- <span> Q1 </span> -->
                                    <span> 如何判斷哪種老花矯視方式適合我？ </span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="14" viewBox="0 0 28 14"
                                        fill="none">
                                        <path d="M26.7441 1L13.879 12.0273" stroke="white" stroke-width="2"
                                            stroke-linecap="round" />
                                        <path d="M1 1L13.8652 12.0273" stroke="white" stroke-width="2"
                                            stroke-linecap="round" />
                                    </svg>
                                </a>
                            </div>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                        ...
                        <defs>
                            <clipPath id="clip0_10302_1589">
                                <rect width="20.4545" height="21.1144" fill="white"
