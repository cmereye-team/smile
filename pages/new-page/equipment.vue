    ...
    <div class="equipment-box">
      ...
      <div class="equipment-items" v-if="!isMobile">
        <div v-for="(item, index) in equipmentList" :key="item.id">
          <div>
            <div>
              <img :src="item.img" :alt="item.alt || item.name[0]" />
            </div>
    ...
    return {
      ...
      equipmentList: [
        ...
        },
        {
          ...
          name: [this.$t("medical_equipment.content1.name1"), this.$t("medical_equipment.content1.name2")],
    ...
    return {
      ...
      link: [
        ...
        },
        {
          rel: "alternate",
          hreflang: "x-default",
          href: "https://smile.hkcmereye.com/medical-equipment/",
        },
        {
          rel: "alternate",
          hreflang: "zh-Hant",
        ...
        },
        {
          rel: "alternate",
          hreflang: "zh-Hans",
          href: "https://smile.hkcmereye.com/cn/medical-equipment/",
        },
      ],
    };
  },
