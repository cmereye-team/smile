        ...
        <tbody>
          ...
          <tr>
            <td>
              ...
              >
                <!-- prettier-ignore -->
                <svg xmlns="http://www.w3.org/2000/svg" class="size-9 md:size-12 lg:size-[52px]" viewBox="0 0 55 32" fill="none"><g clip-path="url(#a)" stroke="#4570b6" stroke-linecap="round" stroke-linejoin="round"><path d="M27.427.85c15.69 0 26.577 15.047 26.577 15.047S43.117 30.944 27.427 30.944.85 15.897.85 15.897 11.736.85 27.427.85" stroke-width="1.702"/><path d="M2.796 18.041C6.593 13.81 15.658 5.344 27.426 5.344c11.77 0 20.834 8.466 24.632 12.697" stroke-width="1.702"/><path d="M27.573 24.105c5.11 0 9.253-3.894 9.253-8.696 0-4.803-4.143-8.697-9.253-8.697s-9.252 3.894-9.252 8.697 4.142 8.696 9.252 8.696" stroke-width="1.379"/><path d="M27.573 19.219c2.24 0 4.055-1.706 4.055-3.81s-1.815-3.811-4.055-3.811-4.055 1.706-4.055 3.81 1.816 3.811 4.055 3.811M7.092 20.942l2.104-2.193s4.063 2.75 6.503 2.505m-4.245-1.964 2.293-2.59m33.938 5.944-2.456-.632s.388-4.796-.54-7.22m-3.246 3.778 3.254 1.398" stroke-width="1.357"/><path d="m18.95 28.406-.005-2.234-1.048-1.563m2.698.44-1.65 1.124m22.356.575-1.066-1.962-1.664-.88m2.584-.893-.92 1.772m-12.591 2.281 1.693 1.528 1.76.062.138 1.952" stroke-width="1.145"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h54.856v31.796H0z"/></clipPath></defs></svg>
                <p>傷口大小</p>
              </div>
            </td>
            <td>約2mm</td>
