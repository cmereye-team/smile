  ...
  <div class="lasik">
    ...
    <div class="smile-banner">
      <img
        ...
        loading="lazy"
        srcset="
          https://statichk.cmermedical.com/smile/smileProCare/banner-mobile.webp 400w,
          https://statichk.cmermedical.com/smile/smileProCare/banner-mobile.webp 768w,
      ...
      <div class="smile-banner__text-wrap">
        <div class="smile-banner__container">
          ...
          <div class="smile-banner__scroll-indicator">
    ...
    <section class="py-16 md:py-24 bg-[#F5F5F7]">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto text-center md:mb-16">
          <h2
            class="text-xl md:text-4xl font-bold text-zeissBlue mb-6 md:text-nowrap"
          >
          ...
          <table class="w-full bg-white rounded-xl shadow-sm">
            ...
            <tbody class="divide-y divide-gray-200">
              <tr class="hover:bg-gray-50 transition-colors">
                <td
                  class="px-2 py-2 md:px-6 md:py-4 font-medium text-zeissBlue text-base text-center md:text-lg text-nowrap md:text-start"
                >
                  眼睛<br class="md:hidden" />水潤護理
                </td>
                <td
                  class="px-2 py-2 md:px-6 md:py-4 text-center bg-red text-lg"
                >
                  1次
                </td>
                <td class="px-2 py-2 md:px-6 md:py-4 text-center text-lg">
                  1次
                </td>
              </tr>
              <tr class="hover:bg-gray-50 transition-colors">
                <td
                  class="px-2 py-2 md:px-6 md:py-4 font-medium text-zeissBlue text-base md:text-lg md:text-start"
                >
                  術後眼部彩光護理
                </td>
                <td
                  class="px-2 py-2 md:px-6 md:py-4 text-center text-zeissLightBlue font-medium text-base md:text-lg text-[#165DFF]"
                >
                  1次
                </td>
                <td
                  class="px-2 py-2 md:px-6 md:py-4 text-center text-base md:text-lg"
                >
                  /
                </td>
              </tr>
              ...
              <tr class="hover:bg-gray-50 transition-colors">
                <td
                  class="px-2 py-2 md:px-6 md:py-4 font-medium text-zeissBlue rounded-bl-xl text-base md:text-lg text-center md:text-start"
                >
    ...
    <div class="how-to-choose">
      ...
      <p class="how-to-choose__description">
        SMILE Pro Care微笑激光矯視最適合
        <span class="how-to-choose__description--bold">重視矯視體驗</span>，
